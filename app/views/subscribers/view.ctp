<div class="actions">
	<ul>
		...
		<li><?php echo $html->link(__('Import Subscribers', true), array('action' => 'import')); ?> </li>
	</ul>
</div>
...
<h2><?php  __('Subscriber');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			...
			(calculated at: <?php echo $subscriber['Subscriber']['issue_start']; ?>)
			&nbsp;
		</dd>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $subscriber['Subscriber']['modified']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
