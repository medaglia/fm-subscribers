<?php
    class MimportShell extends Shell {
        ...
        function main(){
			...
			$soap_url = 'https://filmmakermagazine.accountservergroup.com/~filmmake/buy/index.php/api/?wsdl';

           	$lock_filename = "/home/filmmake/public_html/cake/vendors/shells/lockfiles/mgnt-order-lock.txt";
